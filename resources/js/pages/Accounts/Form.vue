        ...
        <form @submit.prevent="handleSubmit" class="card max-w-2xl">
            <div class="space-y-6">
                ...
                <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    ...
                    />
                    <div>
                        <label for="exclude_from_totals" class="block text-sm font-medium text-gray-900 dark:text-white cursor-pointer">
                            Excluir esta conta dos cálculos
                        </label>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Esta conta continuará aceitando lançamentos, mas seu saldo não será considerado em totais, gráficos, relatórios e orçamentos.
                        </p>
                    </div>
                </div>
    ...
    if (isEditing.value) {
        ...
        try {
            ...
            if (account) {
                ...
                form.exclude_from_totals = account.exclude_from_totals || false;
            }
        } finally {
            loading.value = false;
        }
